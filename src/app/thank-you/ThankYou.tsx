...
const ThankYou = () => {
  const searchParams = useSearchParams()
    ...
    const {configuration,BillingAddress,ShippingAddress,amount} : any = data
    ...
    <div className="bg-white">
      <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <div className="max-w-xl">
          ...
          <p className="mt-2 text-base text-zinc-500">We've recieved your order and now processing it</p>
        ...
        <div className="flex space-x-6 overflow-hidden mt-4 rounded-xl bg-gray-900/5 ring-1 ring-inset ring-gray-900/10 lg:rounded-2xl">
          <PhonePreview croppedImageUrl={croppedImgUrl} color={color!}/>
        </div>
        ...
        <div className="space-y-6 border-t border-zinc-200 pt-10 text-sm">
          ...
          <p className="text-zinc-900 text-xl font-semibold">{formatPrice(amount)}</p>
          </div>
        </div>
